...
export const competitors: Competitor[] = [
  ...
  {
    slug: "truckfile",
    competitorName: "Truckfile",
    competitorTagline: "UK DVSA-Earned-Recognition vehicle-maintenance software",
    competitorUrl: "https://truckfile.co.uk",
    competitorSummary: "Truckfile is a DVSA Earned Recognition accredited vehicle-maintenance system used by UK heavy-goods operators. Listed on .gov.uk alongside FleetCheck, CheckedSafe, Chevin, Vehocheck and 5-6 other vendors. Strong on workshop + maintenance scheduling + driver walkaround capture.",
    pageTitleSuffix: "Truckfile vs MEOK",
    metaDescription: "Truckfile alternative — Truckfile = DVSA ER vehicle-maintenance. MEOK = signed compliance attestations + EU AI Act bridge. Use both; differs on signing + AI governance scope.",
    whenToPickThem: "Pick Truckfile if you want a tried-and-tested DVSA-ER-accredited vehicle-maintenance + walkaround system with a UK customer base. Strong workshop module for in-house fleets.",
    whenToPickMeok: "Pick MEOK when you need cryptographic signing of every compliance check + auto-bridge to EU AI Act / UK DUAA s.80 / NIST AI RMF / ISO 42001. Run both — Truckfile for workshop, MEOK for signed evidence + AI governance.",
    comparison: [
      { feature: "DVSA Earned Recognition accredited", competitor: "Yes (listed on .gov.uk)", meok: "Pending application", meokWins: false },
      { feature: "Driver walkaround check", competitor: "Yes (well-established)", meok: "Yes (signed-by-default)", meokWins: false },
      { feature: "Workshop / maintenance scheduling", competitor: "Core product", meok: "Pair with Truckfile", meokWins: false },
      { feature: "HMAC-SHA256 signed attestations", competitor: false, meok: "Every check", meokWins: true },
      { feature: "Public verifier endpoint", competitor: false, meok: "Yes", meokWins: true },
      { feature: "EU AI Act bridge", competitor: false, meok: "meok-haulage-governance-bridge-mcp", meokWins: true },
      { feature: "UK DUAA s.80 ADM coverage", competitor: false, meok: "Tool-callable", meokWins: true },
      { feature: "BS 7121 lift plans + LOLER", competitor: false, meok: "meok-bs7121-mcp", meokWins: true },
      { feature: "International scope (EU/US/AU/etc.)", competitor: "UK only", meok: "9 jurisdictions", meokWins: true },
      { feature: "Open source MCPs", competitor: false, meok: "All 32", meokWins: true },
      { feature: "Pricing entry", competitor: "Per-vehicle £subscription", meok: "£29/mo Starter (flat)", meokWins: true },
    ],
  },
  {
    slug: "convey",
    competitorName: "Convey",
    competitorTagline: "UK DVSA-ER fleet maintenance + compliance platform",
    competitorUrl: "https://convey.co.uk",
    competitorSummary: "Convey is a DVSA Earned Recognition listed vehicle-maintenance + compliance platform serving UK heavy-goods operators. Lives on the same .gov.uk software list as Truckfile + FleetCheck.",
    pageTitleSuffix: "Convey vs MEOK",
    metaDescription: "Convey alternative — Convey delivers DVSA ER fleet compliance. MEOK adds signed evidence chains + EU AI Act + UK DUAA s.80 bridge. Side-by-side.",
    whenToPickThem: "Pick Convey for a DVSA-ER-accredited fleet compliance + maintenance platform with UK-based support.",
    whenToPickMeok: "Pick MEOK for cryptographically-signed evidence + AI governance crosswalk that Convey doesn't ship today. Plug MEOK alongside.",
    comparison: [
      { feature: "DVSA Earned Recognition", competitor: "Yes", meok: "Pending", meokWins: false },
      { feature: "Fleet maintenance scheduling", competitor: "Core product", meok: "Out of scope", meokWins: false },
      { feature: "HMAC-signed attestations", competitor: false, meok: "Yes", meokWins: true },
      { feature: "Public verifier API", competitor: false, meok: "Yes", meokWins: true },
      { feature: "EU AI Act + ISO 42001 bridge", competitor: false, meok: "Built-in", meokWins: true },
      { feature: "BS 7121 + LOLER + ALLMI", competitor: false, meok: "Native MCPs", meokWins: true },
      { feature: "Open source", competitor: false, meok: "All 32 MCPs MIT", meokWins: true },
      { feature: "International coverage", competitor: "UK only", meok: "9 jurisdictions", meokWins: true },
      { feature: "Pricing entry", competitor: "Enterprise (POA)", meok: "£29/mo Starter", meokWins: true },
      { feature: "Setup time", competitor: "Days (implementation)", meok: "5 min pip install", meokWins: true },
    ],
  },
  {
    slug: "checkedsafe",
    competitorName: "CheckedSafe",
    competitorTagline: "Driver vehicle inspection app + fleet compliance",
    competitorUrl: "https://www.checkedsafe.com",
    competitorSummary: "CheckedSafe is a paperless driver walkaround inspection app + fleet compliance platform. DVSA-ER accredited. Strong on mobile driver UX + photo-evidence capture.",
    pageTitleSuffix: "CheckedSafe vs MEOK",
    metaDescription: "CheckedSafe alternative — CheckedSafe nails driver walkaround mobile UX. MEOK adds cryptographic signing of every check + EU AI Act bridge.",
    whenToPickThem: "Pick CheckedSafe if driver-facing mobile walkaround with photo evidence is your priority and you don't need cross-framework AI governance mapping.",
    whenToPickMeok: "Pick MEOK when every defect report needs to chain into a tamper-evident signed evidence ledger that auditors verify on demand. Pair with CheckedSafe if driver UX matters most.",
    comparison: [
      { feature: "Driver mobile walkaround app", competitor: "Best-in-class", meok: "PWA wrapper of HMAC signing", meokWins: false },
      { feature: "Photo evidence capture", competitor: "Yes (rich)", meok: "Hashed into signed attestation", meokWins: false },
      { feature: "DVSA ER accredited", competitor: "Yes", meok: "Pending", meokWins: false },
      { feature: "HMAC-signed defect chain", competitor: false, meok: "Yes", meokWins: true },
      { feature: "Public verifier endpoint", competitor: false, meok: "Yes", meokWins: true },
      { feature: "EU AI Act + UK DUAA bridge", competitor: false, meok: "Built-in", meokWins: true },
      { feature: "BS 7121 + LOLER lift compliance", competitor: false, meok: "Yes", meokWins: true },
      { feature: "Open source", competitor: false, meok: "MIT all 32 MCPs", meokWins: true },
      { feature: "Pricing entry", competitor: "Per-vehicle/mo", meok: "£29/mo Starter (flat)", meokWins: true },
      { feature: "Setup time", competitor: "Days", meok: "5 min", meokWins: true },
    ],
  },
  {
    slug: "chevin",
    competitorName: "Chevin FleetWave",
    competitorTagline: "Enterprise UK + international fleet management software",
    competitorUrl: "https://www.chevinfleet.com",
    competitorSummary: "Chevin FleetWave is an enterprise-grade fleet management platform used internationally (UK, US, EU). DVSA-ER-listed. Strong on configurable workflows for 500+ vehicle operations.",
    pageTitleSuffix: "Chevin FleetWave vs MEOK",
    metaDescription: "Chevin FleetWave alternative — enterprise FMS for 500+ vehicle operations. MEOK = signed compliance attestation layer that plugs alongside. EU AI Act bridge built in.",
    whenToPickThem: "Pick Chevin FleetWave if you run a 500+ vehicle international fleet and need a deeply configurable FMS with implementation services + global support.",
    whenToPickMeok: "Pick MEOK as the cryptographic evidence layer that sits on top of Chevin — every compliance check signed + auto-bridged to EU AI Act + NIST AI RMF + ISO 42001 for procurement.",
    comparison: [
      { feature: "Enterprise FMS depth", competitor: "Core product", meok: "Out of scope", meokWins: false },
      { feature: "International multi-region", competitor: "Yes (UK + US + EU)", meok: "MCPs cover 9 jurisdictions", meokWins: false },
      { feature: "Configurable workflows", competitor: "Highly configurable", meok: "API-first; integrate yours", meokWins: false },
      { feature: "DVSA ER accredited", competitor: "Yes", meok: "Pending", meokWins: false },
      { feature: "HMAC-signed evidence chain", competitor: false, meok: "Every result", meokWins: true },
      { feature: "Public verifier endpoint", competitor: false, meok: "Yes", meokWins: true },
      { feature: "EU AI Act + UK DUAA s.80 bridge", competitor: false, meok: "Built-in", meokWins: true },
      { feature: "Open source MCPs", competitor: false, meok: "All 32", meokWins: true },
      { feature: "Pricing entry", competitor: "Enterprise (POA)", meok: "£29/mo Starter", meokWins: true },
      { feature: "Setup time", competitor: "Weeks to months", meok: "5 min", meokWins: true },
    ],
  },
  {
    slug: "vehocheck",
    competitorName: "Vehocheck",
    competitorTagline: "Driver vehicle check + compliance app",
    competitorUrl: "https://www.vehocheck.co.uk",
    competitorSummary: "Vehocheck is a UK driver-facing pre-use vehicle inspection app with DVSA-ER recognition. Listed on the .gov.uk software list. Strong driver workflow + simple operator dashboard.",
    pageTitleSuffix: "Vehocheck vs MEOK",
    metaDescription: "Vehocheck alternative — Vehocheck = DVSA ER driver inspection app. MEOK adds signed evidence + AI governance bridge. Honest side-by-side.",
    whenToPickThem: "Pick Vehocheck for a simple, DVSA-ER-accredited driver vehicle-check app focused purely on the walkaround workflow.",
    whenToPickMeok: "Pick MEOK when those walkaround checks need to chain into a signed audit ledger + auto-bridge to EU AI Act + ISO 42001 for cross-framework compliance.",
    comparison: [
      { feature: "Driver vehicle check workflow", competitor: "Core", meok: "Yes (signed PWA)", meokWins: false },
      { feature: "DVSA ER accredited", competitor: "Yes", meok: "Pending", meokWins: false },
      { feature: "HMAC-signed evidence chain", competitor: false, meok: "Yes", meokWins: true },
      { feature: "Public verifier endpoint", competitor: false, meok: "Yes", meokWins: true },
      { feature: "EU AI Act / UK DUAA bridge", competitor: false, meok: "Built-in", meokWins: true },
      { feature: "BS 7121 + LOLER + IATA DGR + MARPOL etc.", competitor: false, meok: "Yes (across 32 MCPs)", meokWins: true },
      { feature: "International scope", competitor: "UK only", meok: "9 jurisdictions", meokWins: true },
      { feature: "Open source", competitor: false, meok: "All MCPs MIT", meokWins: true },
      { feature: "Pricing entry", competitor: "Per-vehicle/mo", meok: "£29/mo Starter", meokWins: true },
      { feature: "Setup time", competitor: "Hours", meok: "5 min", meokWins: true },
    ],
  },
  {
    slug: "prolius",
    competitorName: "Prolius",
    competitorTagline: "UK fleet vehicle maintenance + compliance platform",
    competitorUrl: "https://www.prolius.com",
    competitorSummary: "Prolius is a UK fleet vehicle-maintenance + compliance platform listed on the DVSA Earned Recognition software directory. Strong on maintenance workflow + walkaround.",
    pageTitleSuffix: "Prolius vs MEOK",
    metaDescription: "Prolius alternative — Prolius = DVSA-ER fleet maintenance. MEOK adds cryptographically-signed evidence + EU AI Act bridge. Side-by-side.",
    whenToPickThem: "Pick Prolius for a DVSA-ER-accredited maintenance + compliance platform with a UK-based customer base + support team.",
    whenToPickMeok: "Pick MEOK to bolt signed evidence + AI governance crosswalk on top of Prolius. Run both for the strongest combined posture.",
    comparison: [
      { feature: "DVSA ER accredited", competitor: "Yes", meok: "Pending", meokWins: false },
      { feature: "Fleet maintenance workflow", competitor: "Core", meok: "Out of scope", meokWins: false },
      { feature: "Driver walkaround", competitor: "Yes", meok: "Yes (signed-by-default)", meokWins: false },
      { feature: "HMAC-signed attestations", competitor: false, meok: "Yes", meokWins: true },
      { feature: "Public verifier endpoint", competitor: false, meok: "Yes", meokWins: true },
      { feature: "EU AI Act + UK DUAA bridge", competitor: false, meok: "Built-in", meokWins: true },
      { feature: "BS 7121 lift plans", competitor: false, meok: "meok-bs7121-mcp", meokWins: true },
      { feature: "Open source MCPs", competitor: false, meok: "All 32 MIT", meokWins: true },
      { feature: "Pricing entry", competitor: "Per-vehicle/mo", meok: "£29/mo Starter (flat)", meokWins: true },
      { feature: "International coverage", competitor: "UK only", meok: "9 jurisdictions", meokWins: true },
    ],
  },
